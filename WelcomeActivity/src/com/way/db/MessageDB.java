...
public class MessageDB {
	...
	public void saveMsg(String id, MessageItem entity) {
		...
		db.execSQL("insert into _" + id + " (name,img,date,isCome,message,isNew) values(?,?,?,?,?,?)",
				new Object[] { entity.getName(), entity.getHeadImg(), entity.getDate(), isCome, entity.getMessage(), entity.getIsNew() });
	}
